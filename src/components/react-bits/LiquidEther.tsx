...
const defaultColors = ['#1D4533', '#F9D2BA', '#5E3122'];
...
`;
    ...
    try {
      ...
      // no WebGL on this device — the shell just renders without ambience
      return;
    }
  ...
  return <div ref={mountRef} className={className ? `rb-liquid ${className}` : 'rb-liquid'} style={style} />;
}
